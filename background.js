...
// This file loads the service worker implementation from the backend folder

// Load the service worker implementation
importScripts('backend/service-worker.js');
